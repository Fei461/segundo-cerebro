...
const PREP_GROUP_RULES = {
  "Bases rapidas": {
    ...
    detailPrefix: "Dejar listas bases neutras para montar comidas con poca fricción.",
  ...
  "Lacteos y alternativos": {
    ...
    detailPrefix: "Dejar cubiertos los apoyos más fáciles de la semana.",
    taskPrefix: "Cerrar desayunos y snacks base"
  },
  "Grasas y extras": {
    title: "Ordenar salsas y extras",
    detailPrefix: "Agrupar extras para no improvisar de más en los platos.",
...
export function getWeeklyNutritionReview({ plannedMeals = [], loggedMeals = [], recipes = [] }) {
  ...
  let nextAction = "Seguir registrando para tener una semana más legible.";
    ...
    slotOrder.forEach(slot => {
      ...
      if (selectedRecipe) {
        ...
        suggestions.push({
          ...
          notes:
            needsSimplification
              ? "Sugerido automáticamente como opción simple para un día con mucha carga o baja adherencia."
              : "Sugerido automáticamente para cerrar huecos de la semana.",
          reason:
            agendaLoad >= 2
              ? "agenda-cargada"
