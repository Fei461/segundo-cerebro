...
function renderHomeCapture(current, today) {
  ...
  return `
    <section class="subpanel stack capture-station">
      <div class="section-head">
        <div>
      ...
      <div class="capture-chip-row">${homeCaptureButtons(current)}</div>
    ...
    <section id="home-panel" class="panel stack">
      ...
      <section class="command-center section-block">
        <article class="command-hero headline-card">
          ...
          <div class="chip-row">
            ${quickLink("Comida", "nutrition")}
            ${quickLink("Entreno", "training")}
            ${quickLink("Síntoma", "wellbeing")}
            ${quickLink("Evento", "planning")}
            ${quickLink("Semana", "planning")}
          </div>
        </article>
        <article class="command-side panel-toned">
          <div class="stack compact-stack">
            ...
            <div>
              ...
              <p class="entry-meta">${dailyCommand.reviewSummary.nextStep?.title || "Revisión estable"}</p>
            </div>
          </div>
        </article>
      </section>
        ...
        `
          ...
          <article class="entry">
            <div>
              ...
              <p class="entry-meta">${weeklyReviewSummary.nextStep?.title || "Revisión semanal cerrada"}</p>
