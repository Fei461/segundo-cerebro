  ...
  return `
    <section id="planning-panel" class="panel stack">
      ...
      <section class="fold-grid">
        ...
        ${collapsiblePanel(
          "Recalibracion",
          "Lo que la semana real te esta pidiendo",
          `
            <div class="button-row">
            ...
            <div class="stack">
              ...
              <article class="entry">
                <div>
                  ...
                  <p class="entry-meta">${weeklyHealth.signals.length ? weeklyHealth.signals.map(signal => signal.title).join(" - ") : "Sin senales destacadas esta semana"}</p>
                </div>
              </article>
            </div>
          `
