    ...
    <section id="nutrition-panel" class="panel stack nutrition-panel">
      <div class="section-head">
        <div>
          ...
          <h3>Nutricion, recetas y meal planner</h3>
        </div>
        <p class="muted">La nutricion ya cruza planner, compra, batch cooking y tolerancia para ayudarte a preparar la semana de verdad.</p>
      </div>
      ...
      <section class="subpanel stack">
        <div class="section-head">
          <div>
            ...
            <h4>Compra, meal prep y primeras comidas</h4>
          </div>
        </div>
      ...
      <section class="subpanel stack">
        <div class="section-head">
          <div>
            <p class="eyebrow">Nutricion personal</p>
            <h4>Despensa y plantillas reales</h4>
          </div>
        </div>
        <section class="dashboard-summary">
          <article class="summary-card">
      ...
      <section class="subpanel stack">
        ...
        <div class="planner-grid">
          ${plannerRows(state, state.recipes)}
        </div>
      </section>
