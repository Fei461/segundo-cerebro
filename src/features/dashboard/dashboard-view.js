...
import { getDailyCommandCenter, getOperationalTimeline, getTodayDecisionBoard, getWeeklyPreparationPack, getWeeklyReviewFlow, getWeeklyReviewSummary } from "../../domain/weekly.js";
...
function quickLink(label, href) {
  return `<a class="chip-link" href="${href}">${label}</a>`;
}
...
function prototypeQaItems() {
  const items = [
    ...
    "Cargar demo V1 si quieres probar sin preparar datos",
    ...
    <section id="home-panel" class="panel stack">
      <div class="section-head">
        <div>
          ...
          <h3>Hoy y semana en una misma vista</h3>
        </div>
        <p class="muted">La home ya empieza a decidir contigo: que toca hoy, donde esta la friccion real y cual es el siguiente movimiento util.</p>
      </div>
      ...
      <section class="command-center">
        <article class="command-hero">
          ...
          <div class="chip-row">
            ${quickLink("Registrar comida", "#meal-form")}
            ${quickLink("Registrar entreno", "#training-form")}
            ${quickLink("Registrar sintoma", "#symptom-form")}
            ${quickLink("Crear evento", "#event-form")}
            ${quickLink("Ajustar semana", "#weekly-form")}
          </div>
        </article>
        <article class="command-side">
          <div class="stack compact-stack">
            <div>
              <p class="eyebrow">Foco de hoy</p>
            ...
            <div>
              <p class="eyebrow">Fricciones detectadas</p>
      ...
      <section class="dashboard-summary">
        ...
        ${summaryMetric("Eventos hoy", dailyCommand.eventsToday.length, "agenda")}
        ...
        ${summaryMetric("Revision 7d", weeklyReviewCount, "logs utiles para revisar")}
        ${summaryMetric("Revision semanal", `${weeklyReviewSummary.completion}%`, weeklyReviewSummary.nextStep?.title || "todo revisado")}
        ${summaryMetric("Presion de hoy", dailyCommand.dayPressure?.status || "estable", dailyCommand.dayPressure ? `${dailyCommand.dayPressure.pressureScore.toFixed(1)} puntos` : "sin lectura")}
        ...
        ${summaryMetric("Sintomas hoy", dailyCommand.symptomsToday.length, "registro diario")}
      </section>
      ...
      <div class="planning-grid">
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              ...
              <h4>Reducir friccion de captura</h4>
            </div>
          </div>
          <div class="button-row button-row-start">
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              <p class="eyebrow">Cerrar el dia</p>
              <h4>Actualizar previsto vs real sin salir de home</h4>
            </div>
          </div>
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              ...
              <h4>Energia, animo y digestion de hoy</h4>
            </div>
          </div>
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              ...
              <h4>Comida sin salir de home</h4>
            </div>
          </div>
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              <p class="eyebrow">Registro rapido</p>
              <h4>Entreno sin salir de home</h4>
            </div>
          </div>
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              <p class="eyebrow">Proximas decisiones</p>
        ...
        <section class="subpanel stack">
          <div class="section-head">
            <div>
              ...
              <h4>Hacer, suavizar y capturar</h4>
            </div>
          </div>
        ...
        ${collapsiblePanel("Checklist de prueba real", "Que probar primero en esta V1", prototypeQaItems(), true)}
