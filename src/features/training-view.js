...
function weeklyCrossSignals(state) {
  ...
  if (signals.length === 0) {
    return `<p class="muted">Aun no hay suficientes cruces entre entreno, recuperacion y ciclo para una lectura semanal potente.</p>`;
  }
    ...
    <section id="training-panel" class="panel stack">
      <div class="section-head">
        <div>
          ...
          <h3>Entreno util y programable</h3>
        </div>
      ...
      <section class="subpanel stack panel-toned">
        <div class="section-head">
          <div>
            ...
            <h4>Entreno, recuperacion y ciclo</h4>
          </div>
        </div>
